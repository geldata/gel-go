...
func BuildScalarEncoder(desc descriptor.Descriptor) (Encoder, error) {
	...
	case DecimalID:
		return nil, errors.New("decimal codec not implemented. " +
			"Consider implementing your own geltypes.DecimalMarshaler " +
			"and geltypes.DecimalUnmarshaler.")
	case BoolID:
...
func buildScalarDecoder(
	...
	if desc.Type == descriptor.Enum {
		...
		default:
			expectedType = "string or geltypes.OptionalStr"
			goto TypeMissmatch
		}
	}
	...
	case UUIDID:
		...
		default:
			expectedType = "uuid or geltypes.OptionalUUID"
		}
	case StrID:
		switch typ {
		case strType:
	...
	case BytesID:
		...
		default:
			expectedType = "[]byte or geltypes.OptionalBytes"
		}
	case Int16ID:
		switch typ {
		case int16Type:
		...
		default:
			expectedType = "int16 or geltypes.OptionalInt16"
		}
	case Int32ID:
		switch typ {
		case int32Type:
		...
		default:
			expectedType = "int32 or geltypes.OptionalInt32"
		}
	case Int64ID:
		switch typ {
		case int64Type:
		...
		default:
			expectedType = "int64 or geltypes.OptionalInt64"
		}
	case Float32ID:
		switch typ {
		case float32Type:
		...
		default:
			expectedType = "float32 or geltypes.OptionalFloat32"
		}
	case Float64ID:
		switch typ {
		case float64Type:
		...
		default:
			expectedType = "float64 or geltypes.OptionalFloat64"
		}
	case DecimalID:
		return nil, errors.New("decimal codec not implemented. " +
			"Consider implementing your own geltypes.DecimalMarshaler " +
	...
	case BoolID:
		...
		default:
			expectedType = "bool or geltypes.OptionalBool"
		}
	case DateTimeID:
		switch typ {
		case dateTimeType:
		...
		default:
			expectedType = "geltypes.DateTime or geltypes.OptionalDateTime"
		}
	case LocalDTID:
		switch typ {
		...
		default:
			expectedType = "geltypes.LocalDateTime or " +
	...
	case LocalDateID:
		...
		default:
			expectedType = "geltypes.LocalDate or geltypes.OptionalLocalDate"
		}
	case LocalTimeID:
		switch typ {
		case localTimeType:
		...
		default:
			expectedType = "geltypes.LocalTime or geltypes.OptionalLocalTime"
		}
	case DurationID:
		switch typ {
		case durationType:
		...
		default:
			expectedType = "geltypes.Duration or geltypes.OptionalDuration"
		}
	case JSONID:
	...
	case BigIntID:
		...
		default:
			expectedType = "*big.Int or geltypes.OptionalBigInt"
		}
	case RelativeDurationID:
		switch typ {
		...
		default:
			expectedType = "geltypes.RealtiveDuration or " +
	...
	case DateDurationID:
		...
		default:
			expectedType = "geltypes.DateDuration or " +
	...
	case MemoryID:
		...
		default:
			expectedType = "geltypes.Memory or geltypes.OptionalMemory"
		}
	default:
		s := fmt.Sprintf("%#v\n", desc)
		return nil, fmt.Errorf("unknown scalar type id %v %v", desc.ID, s)
